...
import type { LibraryState, LifecycleState, SchoolOnboardingState, StudiWorkspaceState, TaskDetail } from "../../shared/index.js";
import { Inky, type InkyState } from "./Inky.js";
import { Field, PaperCard, StatusPill, executionLabel, formatDateTime, formatDue } from "./Ui.js";
...
export function DeskScreen({
  ...
  const inkyState: InkyState = execution.phase === "working" || execution.phase === "submitting" ? "working" : execution.phase === "needs_user" ? "needs" : execution.phase === "ready_review" ? "waiting" : execution.phase === "submitted" || execution.phase === "preserved" ? "done" : "thinking";
