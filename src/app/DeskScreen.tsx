...
export function DeskScreen({
  ...
  const inkyState: InkyState = workspace?.browser.driver === "inky"
    ? "steering"
    : execution.phase === "working" || execution.phase === "submitting" ? "working" : execution.phase === "needs_user" ? "needs" : execution.phase === "ready_review" ? "waiting" : execution.phase === "submitted" || execution.phase === "preserved" ? "done" : "thinking";
