...
8. **Work.** Follow [desktop-pass.md](desktop-pass.md) to prove a real reply, assignment reference, browser handoff, and saved draft. The fixture's `/health` reports `answerSaved` and `submitted` without returning answer content.
