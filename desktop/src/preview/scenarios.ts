...
export const DEV_PREVIEW_SCENARIOS: readonly {
  ...
  { id: "onboarding-chatgpt", group: "Onboarding", title: "Connect ChatGPT", note: "Agent runtime" },
  {
    ...
    note: "Gmail, Drive, Docs, Notion, GitHub",
  },
  ...
  { id: "onboarding-school", group: "Onboarding", title: "School link", note: "Class site" },
  {
    ...
    note: "Attempt and submission default",
  },
  ...
  { id: "onboarding-handoff", group: "Onboarding", title: "Needs student", note: "Linked-site sign-in" },
  {
    ...
    group: "Onboarding",
    title: "Week ready",
    note: "Partial but truthful completion",
  },
  {
    id: "chat-expanded",
    group: "Chat & updates",
    title: "chat expanded",
    note: "Interactive real component fixture",
  },
  {
    id: "chat-thinking",
    group: "Chat & updates",
  ...
  },
  {
    id: "chat-handoff",
    group: "Chat & updates",
    title: "School sign-in handoff",
    note: "Resume a scan from the conversation",
  },
  {
    id: "week-error",
    group: "Chat & updates",
  ...
  },
  {
    id: "week-conflicts",
    group: "School scan",
    title: "Class permission conflict",
    note: "Simulated unresolved class aliases",
  },
  ...
  {
    id: "week-browser-busy",
    group: "School scan",
    title: "Assignment using browser",
    note: "Simulated stop-and-scan",
  },
  ...
  { id: "week-undated", group: "Workspace", title: "Without dates", note: "Undated work, grouped by class" },
  {
    ...
    note: "Homework conversation and files",
  },
  {
    id: "assignment-failed",
    group: "Workspace",
    title: "Assignment retry",
    note: "Simulated failure and retry",
  },
  {
    id: "assignment-stopped",
    group: "Workspace",
    title: "Stopped assignment",
    note: "Student cancelled work",
  },
  {
    id: "assignment-restricted",
    group: "Workspace",
    title: "Assignment permission",
    note: "Disabled start and homework rules",
  },
  {
    id: "assignment-saved",
    group: "Workspace",
    title: "Saved assignment",
    note: "Answers saved, submission unconfirmed",
  },
  ...
  ...SETTINGS_SECTIONS.map((section) => ({
    id: `settings-${section.id}` as const,
    group: "Settings",
    title: section.label,
    note: section.hint,
  })),
...
export function parsePreviewConfig(search: string): DevPreviewConfig | null {
  ...
  const settingsSection = id.startsWith("settings-")
    ? (id.slice("settings-".length) as DevPreviewConfig["settingsSection"])
    : undefined;
  const onboardingStep = (
    ...
    } as Partial<Record<DevPreviewScenarioId, DevPreviewConfig["onboardingStep"]>>
  )[id];
  const panel: DeskPanel =
    id === "assignment" || id.startsWith("assignment-")
  ...
  return {
    id,
    screen: settingsSection ? "settings" : "week",
    panel,
