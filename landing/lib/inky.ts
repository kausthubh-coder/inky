...
const extras: Record<string, string> = {
  ...
  working: `<g class="extra pen"><g transform="rotate(-48 86 78)"><rect x="83" y="62" width="6" height="22" rx="2" fill="#f7c948" stroke="#3b342c" stroke-width="2.4"/><rect x="83" y="62" width="6" height="3.5" rx="1.2" fill="#f28b6f" stroke="#3b342c" stroke-width="2.2"/><path d="M83 84 L89 84 L86 93 Z" fill="#3b342c"/></g></g>`,
  thinking: `<g class="extra think"><g class="spark a"><path d="M76 8 l1.4 3.4 3.6 1.4 -3.6 1.4 -1.4 3.4 -1.4 -3.4 -3.6 -1.4 3.6 -1.4 z" fill="#f7c948" stroke="#3b342c" stroke-width="1.2" stroke-linejoin="round"/></g><g class="spark b"><path d="M124 14 l1.1 2.8 3 1.1 -3 1.1 -1.1 2.8 -1.1 -2.8 -3 -1.1 3 -1.1 z" fill="#f2a8c4" stroke="#3b342c" stroke-width="1.2" stroke-linejoin="round"/></g><g class="puff"><circle cx="84" cy="44" r="5" fill="#fff" stroke="#3b342c" stroke-width="2.4"/></g><g class="bubble"><path d="M90 32 C88 16 100 6 112 8 C124 10 132 20 128 32 C136 34 138 46 128 50 C124 60 108 60 100 52 C88 56 80 46 84 36 C86 34 88 33 90 32 Z" fill="#fff" stroke="#3b342c" stroke-width="2.6" stroke-linejoin="round"/><text class="q" x="110" y="40" text-anchor="middle" font-family="Shantell Sans, Patrick Hand, cursive" font-weight="800" font-size="22" fill="#3b342c">?</text></g></g>`,
...
export function inkySvg(state: string, size: number): string {
  ...
  const attached = safe === "hello" || safe === "working" || safe === "scanning" || safe === "steering";
  const extra = extras[safe] ?? "";
  return `<svg width="${size}" height="${size}" viewBox="${safe === "hello" ? "-16 0 136 120" : "0 0 120 120"}" aria-hidden="true">
