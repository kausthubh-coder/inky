    ...
    <>
      <header className="account-heading">
        <div>
          ...
          <p>
            Your browser account makes sign-in faster. Studi still creates and verifies its own one-time PKCE
            transaction.
          </p>
        </div>
      </header>
      <section className="account-panel">
        <div className="connect-steps">
          <div className="connect-step">
            <strong>Open Studi</strong>
            <span>The installed app receives only a connect command.</span>
          </div>
          <div className="connect-step">
            <strong>Approve in Clerk</strong>
            <span>Your signed-in browser can reuse this account.</span>
          </div>
          <div className="connect-step">
            <strong>Return to the app</strong>
            <span>Studi exchanges the code with its private PKCE verifier.</span>
          </div>
        </div>
        ...
        {windowsDownloadUrl || macDownloadUrl ? (
          <div className="connect-note">
            ...
            <div className="download-links">
              {windowsDownloadUrl ? (
                <a className="btn" href={windowsDownloadUrl}>
                  Download for Windows
                </a>
              ) : null}
              {macDownloadUrl ? (
                <a className="btn" href={macDownloadUrl}>
                  Download for Mac
                </a>
              ) : null}
            </div>
        ...
        {showHelp ? (
          <div className="connect-note" role="status">
            ...
            <span>
              {windowsDownloadUrl || macDownloadUrl
                ? "Download Studi above, install it, then press Open Studi again."
                : "Install Studi, then press Open Studi again."}
            </span>
          </div>
        ) : null}
      </section>
