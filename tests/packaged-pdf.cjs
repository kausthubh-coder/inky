...
app.whenReady().then(async () => {
  ...
  console.log(JSON.stringify({ status: 'passed', archive, architecture: process.arch, electron: process.versions.electron, checks: ['packaged production PDF tool', 'text page', 'scanned page image', 'worker, fonts and native canvas'] }));
  app.exit(0);
